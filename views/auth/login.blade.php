...
@section('content')
    ...
    <h4 class="fw-300 c-grey-900 mB-40">تسجيل الدخول</h4>
    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
        {{ csrf_field() }}

        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            <label for="email" class="text-normal text-dark">البريد الالكتروني</label>
        ...
        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            <label for="password" class="text-normal text-dark">كلمة السر</label>
                ...
                <div class="peer">
                    <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                        ...
                        <label for="remember" class=" peers peer-greed js-sb ai-c">
                            <span class="peer peer-greed">  Me</span>
                        </label>
                    </div>
                </div> --}}
                <div class="peer">
